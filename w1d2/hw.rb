...
def add_numbers(nums_array)
  return nums_array[0] if nums_array.length <= 1 # arr.first is 'ruby-er'
...
# Test Cases
# p gamma_func(0)  # => returns nil
# p gamma_func(1)  # => returns 1
# p gamma_func(4)  # => returns 6
# p gamma_func(8)  # => returns 5040
